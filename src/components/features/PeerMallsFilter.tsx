...
import { PeermallFiltersProps } from '@/types/peermall';



const PeerMallsFilter = ({ onFilterChange, initialFilters }: PeermallFiltersProps) => {
  ...
  }, [selectedCategories, selectedRating, selectedStatus, searchQuery]);
  ...
  }, [selectedCategories, selectedRating, selectedStatus, searchQuery, onFilterChange]);
...
export default PeerMallsFilter;